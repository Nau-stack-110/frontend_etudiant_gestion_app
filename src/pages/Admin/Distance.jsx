...
import { FiEye, FiDownload, FiX, FiPlus, FiFilter, FiChevronDown, FiSearch, FiEdit, FiTrash2, FiSave } from "react-icons/fi";
...
export default function StudentsTable() {
  ...
  const fetchStudents = async () => {
    try {
      ...
      const filtered = res.data.filter(student => 
        student.category_nom === 'A distance'
      )
  ...
  const handleCreateStudent = () => {
    const presentielCategory = categories.find(cat => cat.nom_category === 'A distance');
      setFormData({
        matricule: "",
        etudiant_email: "",
        nom: "",
        ...
        moyenne: null,
        responsabilite: "",
        category: presentielCategory?.id || null 
      });
      ...
      {error && (
        <div className="bg-red-100 text-red-700 p-4 rounded-lg mb-4">
         ...
         <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-indigo-800">Étudiants à Distance</h1>
              <button
